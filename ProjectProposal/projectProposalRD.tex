...
\begin{itemize}
In the main menu we will have buttons for all three games. there will also be a button to exit the program. then the three games themselves will have functions to start and maintain the game. a database to set usernames, passwords, and the users balance. In each game window, it will have an exit and back button to enter the main menu.
\end{itemize}

\subsubsection{Non-Functional}
\begin{itemize}
As a stretchgoal we will have a tutorial for each game. The visual background of the main menu and the three main games and other games.
\end{itemize}
