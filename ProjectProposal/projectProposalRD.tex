...
\begin{itemize}
In the main menu we will have buttons for all three games. there will also be a button to exit the program. then the three games themselves will have functions to start and maintain the game. a database to set usernames, passwords, and the users balance.
\end{itemize}
